...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qzfc1ma.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qzfc1ma.containers.anotherwebservice.com/
...
```
git clone git@github.com:starkyuii/container-qzfc1ma.git
cd container-qzfc1ma
```
...
```
docker attach container-qzfc1ma
```
